...
Makefile.conf: 
	coq_makefile Tactics.v AdditionalTactics.v FSetDecide.v FSetNotin.v ListFacts.v FiniteSets.v Atom.v Metatheory.v CoqIntro.v Environment.v Fsub_Definitions.v Fsub_Infrastructure.v Fsub_Lemmas.v Fsub_LetSum_Definitions.v Fsub_LetSum_Infrastructure.v Fsub_LetSum_Lemmas.v Fsub_LetSum_Soundness.v Fsub_Soundness.v STLC_Tutorial.v STLC_Solutions.v -o Makefile
